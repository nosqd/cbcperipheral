...
public class FixedCannonMountPeripheral implements IPeripheral {
    ...
    static {
        try {
            F_CANNON_YAW = FixedCannonMountBlockEntity.class.getDeclaredField("cannonYaw");
            F_CANNON_YAW.setAccessible(true);

            F_CANNON_PITCH = FixedCannonMountBlockEntity.class.getDeclaredField("cannonPitch");
            F_CANNON_PITCH.setAccessible(true);

            F_RUNNING = FixedCannonMountBlockEntity.class.getDeclaredField("running");
            F_RUNNING.setAccessible(true);

            M_ASSEMBLE = FixedCannonMountBlockEntity.class.getDeclaredMethod("assemble");
